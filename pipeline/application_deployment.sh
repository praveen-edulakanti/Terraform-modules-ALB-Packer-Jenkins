...
echo "$WORKSPACE"
$S3BucketName = $3
sudo wget https://$S3BucketName.s3.ap-south-1.amazonaws.com/code_repo/user.zip
sudo wget https://$S3BucketName.s3.ap-south-1.amazonaws.com/code_repo/dashboard.zip
